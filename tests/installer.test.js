...
assert.equal(
  context.__installerTestApi.extractVersion(
    'const APP = { version: "1.2.0" };'
  ),
  "1.2.0"
);
assert.equal(context.__installerTestApi.compareVersions("1.1.0", "1.2.0"), -1);
assert.equal(context.__installerTestApi.compareVersions("1.2.0", "1.2.0"), 0);
assert.equal(context.__installerTestApi.compareVersions("2.0.0", "1.2.0"), 1);
assert.equal(
